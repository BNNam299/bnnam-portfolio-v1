...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUpRight, Mail, Phone, ExternalLink, Menu, X, Sun, Moon, Globe, Sparkles, Lightbulb, MousePointer2, Zap, Pencil, PenTool, ZoomIn, Clock } from 'lucide-react';
...
const PROJECTS: Project[] = [
  {
    ...
    description: { vi: 'Ứng dụng di động giúp người dùng đo đạc và quản lý diện tích đất hoặc mặt bằng trực tiếp trên điện thoại, kết hợp bản đồ tương tác với hệ thống quản lý dự án có cấu trúc.', en: 'Mobile app helping users measure and manage land or surface area directly on their phones, combining interactive maps with a structured project management system.' },
    shortDescription: { vi: 'Ứng dụng đo và quản lý diện tích trên map', en: 'Area measurement and management app on map' },
  ...
  },
  {
    ...
    description: { vi: 'Ứng dụng “foodating” giúp kết nối mọi người thông qua những buổi ăn uống. Người dùng có thể lên lịch hẹn ăn, chọn món, chọn địa điểm và khám phá những người có cùng gu ẩm thực.', en: 'A "foodating" app that connects people through dining experiences. Users can schedule dining dates, choose dishes, select locations, and discover people with similar culinary tastes.' },
    shortDescription: { vi: 'Ứng dụng quản lý tài chính cá nhân thông minh', en: 'Smart personal finance management app' },
  ...
  },
  {
    ...
    description: { vi: 'Dự án thiết kế các social posts nhằm nâng cao mức độ nhận cho thương hiệu MLegend miền Bắc, từ đó thu hút nhóm khách hàng mục tiêu là những người đam mê nâng cấp đèn xe ô tô.', en: 'Social media post design project aimed at increasing brand awareness for MLegend in the North, thereby attracting the target audience of car lighting upgrade enthusiasts.' },
    shortDescription: { vi: 'Thiết kế nhận diện thương hiệu & bao bì', en: 'Brand identity & packaging design' },
  ...
  },
  {
    ...
    description: { vi: 'Dự án này thực hiện việc thiết kế các bài đăng trên mạng xã hội nhằm hỗ trợ chương trình MRS. EARTH VIETNAM thu hút một lượng lớn người theo dõi và ủng hộ cho cuộc thi sắc đẹp này.', en: 'This project involves designing social media posts to support the MRS. EARTH VIETNAM program in attracting a large number of followers and supporters for this beauty pageant.' },
    shortDescription: { vi: 'Thiết kế hình ảnh sự kiện & cuộc thi', en: 'Event & pageant visual design' },
  ...
  },
  {
    ...
    duration: { vi: '4 tuần', en: '4 weeks' },
    description: { vi: 'Ứng dụng fitness sử dụng AI để theo dõi chuyển động và tự động đếm số lần chống đẩy theo thời gian thực, giúp bạn tập luyện hoàn toàn rảnh tay, không cần thao tác nhiều với thiết bị trong quá trình tập luyện.', en: 'Fitness app using AI to track movement and automatically count pushups in real-time, allowing for completely hands-free workouts without needing to interact with the device during exercise.' },
    shortDescription: { vi: 'Ứng dụng đếm hít đất tự động', en: 'Automatic pushup counting app' },
    image: `./image/UIUX_Project/pushup-counter/Thumbnail-2.webp`,
    homeThumbnail: `./image/UIUX_Project/pushup-counter/Thumbnail-1.webp`,
    problem: { vi: 'Người dùng khó tự đếm số lần hít đất chính xác khi tập luyện.', en: 'Users find it difficult to count pushups accurately while exercising.' },
    research: { vi: 'Nghiên cứu công nghệ nhận diện chuyển động qua camera điện thoại.', en: 'Research on motion recognition technology via phone camera.' },
    solution: { vi: 'Sử dụng AI để nhận diện tư thế và đếm số lần hít đất tự động.', en: 'Use AI to recognize posture and count pushups automatically.' },
  ...
  },
  {
    ...
    duration: { vi: '4 tuần', en: '4 weeks' },
    description: { vi: 'Stitch Photos v2.0 là bản nâng cấp toàn diện của bản V1.0, với giao diện Liquid Glass hoàn toàn mới và tính năng đột phá: tạo ảnh ghép trực tiếp từ video', en: 'Stitch Photos v2.0 is a comprehensive upgrade of V1.0, featuring an all-new Liquid Glass interface and a breakthrough feature: creating photo stitches directly from videos.' },
    shortDescription: { vi: 'Ứng dụng ghép ảnh dài', en: 'Long photo stitching app' },
    image: `./image/UIUX_Project/stitch-photos/Thumbnail-2.webp`,
    homeThumbnail: `./image/UIUX_Project/stitch-photos/Thumbnail-1.webp`,
    problem: { vi: 'Người dùng muốn ghép nhiều ảnh màn hình thành một ảnh dài nhưng các công cụ hiện tại phức tạp.', en: 'Users want to stitch multiple screenshots into a long photo but current tools are complex.' },
    research: { vi: 'Nghiên cứu thuật toán nhận diện điểm chung giữa các ảnh.', en: 'Research on algorithms to identify common points between photos.' },
    solution: { vi: 'Tự động tìm điểm chung và ghép nối mượt mà các ảnh màn hình.', en: 'Automatically find common points and smoothly stitch screenshots.' },
  ...
  },
  {
    ...
    chip: { vi: 'Đang cập nhật...', en: 'Updating...' },
    duration: { vi: '4 tuần', en: '4 weeks' },
    description: { vi: 'Ứng dụng tạo danh thiếp.', en: 'Business card maker app.' },
    shortDescription: { vi: 'Ứng dụng tạo danh thiếp', en: 'Business card maker app' },
    ...
    problem: { vi: 'Người dùng cần một công cụ nhanh chóng để tạo danh thiếp chuyên nghiệp.', en: 'Users need a quick tool to create professional business cards.' },
    research: { vi: 'Nghiên cứu các mẫu danh thiếp phổ biến và quy trình thiết kế.', en: 'Research popular business card templates and design processes.' },
    solution: { vi: 'Cung cấp các mẫu có sẵn và công cụ chỉnh sửa trực quan.', en: 'Provide pre-made templates and intuitive editing tools.' },
  ...
  },
  {
    ...
    chip: { vi: 'Đang cập nhật...', en: 'Updating...' },
    duration: { vi: '4 tuần', en: '4 weeks' },
    description: { vi: 'Ứng dụng thử nghiệm kiểu tóc.', en: 'Hairstyle try-on app.' },
    shortDescription: { vi: 'Ứng dụng thử kiểu tóc', en: 'Hairstyle try-on app' },
    ...
    problem: { vi: 'Người dùng khó hình dung kiểu tóc mới sẽ trông như thế nào trên khuôn mặt họ.', en: 'Users find it hard to imagine how a new hairstyle will look on their face.' },
    research: { vi: 'Nghiên cứu công nghệ AR và nhận diện khuôn mặt.', en: 'Research AR technology and facial recognition.' },
    solution: { vi: 'Sử dụng AI/AR để ướm thử các kiểu tóc khác nhau lên khuôn mặt người dùng theo thời gian thực.', en: 'Use AI/AR to try different hairstyles on the user\'s face in real-time.' },
  ...
  },
  {
    ...
    chip: { vi: 'Đang cập nhật...', en: 'Updating...' },
    duration: { vi: '4 tuần', en: '4 weeks' },
    description: { vi: 'Ứng dụng quản lý tủ quần áo.', en: 'Wardrobe management app.' },
    shortDescription: { vi: 'Ứng dụng quản lý tủ đồ', en: 'Wardrobe management app' },
    image: `./image/UIUX_Project/wardrobe/Thumbnail-2.webp`,
    homeThumbnail: `./image/UIUX_Project/wardrobe/Thumbnail-2.webp`,
    problem: { vi: 'Người dùng có quá nhiều quần áo nhưng luôn cảm thấy không có gì để mặc.', en: 'Users have too many clothes but always feel like they have nothing to wear.' },
    research: { vi: 'Nghiên cứu thói quen sắp xếp đồ đạc và phối đồ hàng ngày.', en: 'Research daily organizing and outfit matching habits.' },
    solution: { vi: 'Số hóa tủ đồ, gợi ý phối đồ bằng AI và theo dõi tần suất sử dụng trang phục.', en: 'Digitize the wardrobe, suggest outfits using AI, and track clothing usage frequency.' },
    folder: 'wardrobe'
  }
];
...
const SectionHeader = ({ title, accent, sub, titleSize = "text-[clamp(32px,7vw,80px)]", titleClassName = "" }: { title: string, accent: string, sub: string, titleSize?: string, gap?: string, titleClassName?: string }) => (
  <div className="flex flex-col items-center mb-20 md:mb-12 text-center relative z-10 px-4">
    ...
    >
      <h2 className={`font-display ${titleSize} leading-[1.1] font-bold text-accent text-center mx-auto ${titleClassName}`}>
        {title} {accent}
      </h2>
    ...
    <div className="min-h-screen selection:bg-accent selection:text-white relative">
      ...
      <div className={`${selectedProject ? 'absolute' : 'fixed'} z-50 transition-all duration-500 flex justify-center items-center ${scrolled && !selectedProject ? 'top-6 w-full px-6' : 'top-0 w-full px-0'}`}>
        <nav className={`bg-bg/90 backdrop-blur-md border-black/5 transition-all duration-500 flex items-center ${scrolled && !selectedProject ? 'rounded-full pl-4 md:pl-6 pr-1.5 py-1.5 shadow-2xl border gap-4 md:gap-12' : 'w-full px-6 py-4 md:py-6 border-b rounded-none justify-between'}`}>
          <a href="/" onClick={(e) => { e.preventDefault(); resetView(); window.scrollTo(0,0); }} className="shrink-0 flex items-center">
            <img src="./image/logo/logo.svg" alt="Logo" className="h-10 md:h-12 w-auto brightness-0 dark:invert" referrerPolicy="no-referrer" />
          </a>
              ...
              <section id="hero" className="min-h-screen relative flex flex-col justify-center items-center px-[5%] pt-[160px] pb-20 rounded-none overflow-hidden bg-white dark:bg-zinc-950 transition-colors duration-500 text-center">
                ...
                <div className="max-w-4xl mx-auto w-full flex flex-col items-center relative z-10">
                  ...
                  <motion.h1 
                    ...
                    style={{ fontSize: 'clamp(22px, 8.5vw, 110px)', lineHeight: '1' }}
                  >
                          ...
                          {PROJECTS.filter(p => p.category === activeFolder).map((project, index) => {
                            return (
                              <motion.div
                                ...
                                whileHover={project.chip?.en === 'Updating...' ? {} : { 
                                  scale: 1.05, 
                                  y: -10,
                                  rotate: -2,
                                  zIndex: 20,
                                ...
                                data-cursor-label={project.chip?.en === 'Updating...' ? '' : (lang === 'vi' ? 'Xem chi tiết' : 'View Details')}
                              ...
                              >
                                ...
                                <div className="flex p-3 sm:p-4 justify-between items-end gap-3 sm:gap-4 self-stretch rounded-[16px] sm:rounded-[22px] bg-white border-2 border-[#f2f2f2] dark:bg-zinc-900 dark:border-zinc-800 flex-1">
                                  <div className="flex flex-col items-start gap-3 sm:gap-4 flex-1 min-w-0">
                                    <div className="flex flex-nowrap gap-2 overflow-hidden w-full">
                                      <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-[#DAF3FF] dark:bg-sky-900/30 text-[#00A3FF] dark:text-sky-400 rounded-full text-xs sm:text-sm font-bold whitespace-nowrap truncate min-w-0 shrink">
                                        {project.tag.split(' ').length > 3 ? project.tag.split(' ').slice(0, 3).join(' ') + '...' : project.tag}
                                      </span>
                                      {project.chip && (
                                        <span className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-bold whitespace-nowrap truncate min-w-0 shrink ${
                                          project.chip.en === 'Updating...' 
                                            ? 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400' 
                                            : 'bg-[#DAF3FF] dark:bg-sky-900/30 text-[#00A3FF] dark:text-sky-400'
                                        }`}>
                                          {project.chip[lang].split(' ').length > 3 ? project.chip[lang].split(' ').slice(0, 3).join(' ') + '...' : project.chip[lang]}
                                        </span>
                                      )}
                                    </div>
                                  ...
                                  <div className={`w-10 h-10 sm:w-12 sm:h-12 shrink-0 text-white rounded-full flex items-center justify-center shadow-md transition-transform ${project.chip?.en === 'Updating...' ? 'bg-zinc-400 dark:bg-zinc-600' : 'bg-[#00A3FF] group-hover:scale-110'}`}>
                                    {project.chip?.en === 'Updating...' ? (
                        ...
                        <div className="relative p-8 md:p-12 z-20">
                          ...
                          >
                            {(() => {
                              ...
                              return (
                                <>
                                  <span className="text-accent font-bold italic font-display block mb-2">{firstLine}</span>
                                  {rest && <span className="text-ink dark:text-white/90 font-normal not-italic">{rest}</span>}
                                </>
                              );
                            })()}
                          </div>
                        ...
                        {t.whatIHave.experience.items.map((item, i) => (
                          <div key={i} className="flex gap-4 lg:gap-6 group">
                            ...
                            <div className="space-y-1">
                              <h4 className="text-base md:text-xl font-bold text-ink dark:text-white leading-tight">{item.role}</h4>
                      ...
                      <div className="space-y-10">
                        {t.whatIHave.education.items.map((item, i) => (
                          <div key={i} className="flex gap-4 lg:gap-6 group">
                            <div className="w-4 h-4 border-[3px] border-accent bg-white dark:bg-zinc-900 rounded-full shrink-0 mt-1.5"></div>
                            <div className="space-y-1">
                              <h4 className="text-base md:text-xl font-bold text-ink dark:text-white leading-tight">{item.school}</h4>
                              <p className="text-[12px] md:text-[13px] font-bold text-ink/40 dark:text-white/40 uppercase tracking-wider">
                    ...
                    <div className="flex flex-col text-center lg:text-left">
                      ...
                      >
                        ...
                        <div className="flex flex-row gap-4 w-full">
                          ...
                          >
                            <img src="./image/Contact/Behance.svg" alt="Behance" className="w-full h-full p-1 md:p-2 object-contain" referrerPolicy="no-referrer" />
                          </motion.a>
                          ...
                          <motion.a 
                            ...
                            className="flex-1 aspect-square md:h-24 rounded-[20px] md:rounded-[30px] bg-white flex flex-col items-center justify-center gap-2 overflow-hidden"
                          >
                            <img src="./image/Contact/Zalo.svg" alt="Zalo" className="w-full h-full p-1 md:p-2 object-contain" referrerPolicy="no-referrer" />
                          </motion.a>
                          ...
                          <motion.a 
                            ...
                            className="flex-1 aspect-square md:h-24 rounded-[20px] md:rounded-[30px] bg-white flex flex-col items-center justify-center gap-2 overflow-hidden"
                          >
                            <img src="./image/Contact/Mail.svg" alt="Email" className="w-full h-full p-1 md:p-2 object-contain" referrerPolicy="no-referrer" />
                          </motion.a>
                          ...
                          <motion.a 
                            ...
                            className="flex-1 aspect-square md:h-24 rounded-[20px] md:rounded-[30px] bg-white flex flex-col items-center justify-center gap-2 overflow-hidden"
                          >
                            <img src="./image/Contact/Phone.svg" alt="Phone" className="w-full h-full p-1 md:p-2 object-contain" referrerPolicy="no-referrer" />
                          </motion.a>
                        </div>
                      </motion.div>
                    </div>
            ...
            >
              <div className="max-w-7xl mx-auto px-[5%]">
                ...
                <div className="mb-16 md:mb-24">
                  <h1 className="font-sans font-bold text-2xl md:text-[40px] leading-tight mt-4 mb-4 md:mb-6 max-w-5xl">{selectedProject.title[lang]}</h1>
                  ...
                  {selectedProject.chip?.en === 'Updating...' ? (
                    <div className="flex flex-col items-center justify-center py-20 md:py-32 text-center">
                      ...
                      <h2 className="text-2xl md:text-3xl font-display font-bold text-ink dark:text-white mb-4">
                        {lang === 'vi' ? 'Dự án đang được cập nhật' : 'Project is being updated'}
                      </h2>
                      <p className="text-ink/60 dark:text-white/60 max-w-md mx-auto">
                        {lang === 'vi' ? 'Chi tiết về dự án này sẽ sớm được ra mắt trong thời gian tới. Vui lòng quay lại sau!' : 'Details about this project will be available soon. Please check back later!'}
                      </p>
                    </div>
                  ) : (
                    <>
              ...
              {selectedProject.chip?.en !== 'Updating...' && (
                            ...
                            {!isAllLoaded && projectImages.length > 0 && (
                              <div className="py-10 flex flex-col items-center justify-center gap-4 text-accent/60">
                                ...
                                <p className="t-caption font-medium animate-pulse">
                                  {lang === 'vi' ? 'Ảnh đang tải lên...' : 'Images are loading...'}
                                </p>
                              </div>
                            )}
                        ...
                        <>
                          ...
                          >
                            ...
                            <div className="relative z-20 p-4 md:p-10 flex flex-col justify-center md:justify-between h-full min-h-[80px] md:min-h-0">
                              <div className="hidden md:block">
                                <span className="t-tag text-accent mb-2 md:mb-4 block">{prevProject.tag}</span>
                                <h3 className="t-h3 text-xl md:text-3xl mb-2 md:mb-4 group-hover:text-accent transition-colors">{prevProject.title[lang]}</h3>
                              </div>
                              <div className="flex items-center justify-center md:justify-start gap-2 t-caption text-accent font-bold text-[10px] md:text-sm uppercase tracking-wider">
                                <ArrowLeft size={14} className="md:w-4 md:h-4" /> {t.detail.prevProject}
                              </div>
                            </div>
                          </motion.div>
                          ...
                          >
                            ...
                            <div className="relative z-20 p-4 md:p-10 flex flex-col justify-center md:justify-between h-full text-right items-center md:items-end min-h-[80px] md:min-h-0">
                              <div className="hidden md:block">
                                <span className="t-tag text-accent mb-2 md:mb-4 block">{nextProject.tag}</span>
                                <h3 className="t-h3 text-xl md:text-3xl mb-2 md:mb-4 group-hover:text-accent transition-colors">{nextProject.title[lang]}</h3>
                              </div>
                              <div className="flex items-center justify-center md:justify-start gap-2 t-caption text-accent font-bold text-[10px] md:text-sm uppercase tracking-wider">
                                {t.detail.nextProject} <ArrowRight size={14} className="md:w-4 md:h-4" />
                              </div>
                            </div>
                          </motion.div>
                        </>
                ...
                <div className="mt-24 pt-16 border-t border-black/5 dark:border-white/10 flex flex-row justify-between items-center gap-4 md:gap-10">
                  ...
                  >
                    {t.detail.contact} <ExternalLink size={18} className="md:w-5 md:h-5" />
                  </a>
                </div>
              </div>
            </motion.div>
